...
- **ซิมการ์ดไทย / eSIM**
  - ถ้าจะรักษาหมายเลขโทรศัพท์ที่ไทยเอาไว้ เช่นเพื่อรับ OTP
    แนะนำให้เปลี่ยนเป็นแบบเติมเงินก่อนจะเดินทางมาไอร์แลนด์ จะประหยัดกว่า
  ...
  - โทรศัพท์หลายรุ่น สามารถใช้ 2 ซิมได้พร้อมกัน
    แต่ซิมที่ 2 ต้องเป็น eSIM - ถ้าต้องการให้ซิมไทยเป็น eSIM ให้ไปทำที่สาขาก่อนออกเดินทาง
  - หากต้องการยืนยันตัวตนในระบบ Mobile ID สามารถทำได้ที่ศูนย์บริการของผู้ให้บริการโทรศัพท์มือถือ
- **บัญชีธนาคารไทย**
  ...
  - ปัจจุบันถ้าจะโอนเงินตั้งแต่ 50,000 บาทต่อรายการ หรือ 200,000 บาทต่อวัน
    [จะต้องยืนยันตัวตนด้วยใบหน้า](https://www.tba.or.th/transfers-over-50000-must-scan-faces-starting-this-june/)
    ถ้าคิดว่าอาจมีเหตุจำเป็นต้องทำธุรกรรมดังกล่าว ให้ไปยืนยันตัวตนที่สาขาหรือตู้เอทีเอ็มเผื่อไว้ก่อน
    โดยจะต้องทำแยกสำหรับแต่ละธนาคาร
- **NDID**
  - ถ้ามีแผนจะทำธุรกรรมออนไลน์ เช่น เปิดบัญชีธนาคาร เปิดบัญชีซื้อขายหลักทรัพย์
    ...
    ของไทยก่อนเดินทาง เนื่องจากการลงทะเบียนครั้งแรกอาจต้องไปยืนยันตัวตนที่สาขาของธนาคาร
    (ติดต่อธนาคารที่เรามีบัญชีอยู่แล้วเพื่อสอบถามการลงทะเบียน NDID - ไม่มีค่าใช้จ่ายในการลงทะเบียน)
- **แอป ThaID**
  - สามารถใช้ยืนยันตัวตนกับบริการอิเล็กทรอนิกส์ของภาครัฐได้ เช่น การยื่นแบบภาษีออนไลน์
  - ให้ติดตั้งแอป และยืนยันตัวตน ตั้งแต่อยู่ที่ไทย
- **แอปเป๋าตัง**
  - สามารถใช้เข้าถึงสวัสดิการของภาครัฐได้ เช่น เงินช่วยเหลือต่างๆ
  - ให้ติดตั้งแอป และยืนยันตัวตน ตั้งแต่อยู่ที่ไทย
- **ใบขับขี่สากล**
  ...
  - ใบขับขี่ระหว่างประเทศตามอนุสัญญาเวียนนา 1968 ที่มีอายุ 3 ปี ใช้ในไอร์แลนด์ไม่ได้ (ใช้ใน UK รวมถึงไอร์แลนด์เหนือได้)
...
- ค่ายโทรศัพท์ที่ราคาถูกคือ [48](https://48.ie/) (โดย Three) กับ [GoMo](https://gomo.ie/) (โดย eir)
  เป็น virtual operator ไม่มีหน้าร้าน สมัครออนไลน์เท่านั้น จ่ายค่าบริการคงที่ทุกเดือน
- สัญญาอินเทอร์เน็ตบ้าน ราคาที่แสดงเป็นราคา 12 เดือนแรก หลังจากนั้นราคาอาจปรับขึ้น
...
- [บัตร SCONUL Access](https://access.sconul.ac.uk/)
  ...
  - ติดต่อทำบัตร SCONUL Access ได้ที่ห้องสมุดมหาวิทยาลัยที่ตัวเองสังกัด
  - Trinity College Dublin เป็นสมาชิก SCONUL แต่ไม่ได้ร่วมโครงการ SCONUL Access
    - สำหรับนักศึกษาระดับบัณฑิตศึกษาที่มีอาจารย์ที่ปรึกษาร่วมจากมหาวิทยาลัยอื่นด้วย
      อาจขอให้อาจารย์ทำบัตรนักศึกษาของอีกมหาวิทยาลัยให้ได้
...
- National Library of Ireland ในดับลิน มีห้องอ่านหนังสือ
  [ทำบัตรใช้ห้องอ่านหนังสือได้ฟรี](https://www.nli.ie/visit/readers-ticket)

## สวัสดิการ บริการของรัฐ เครดิตภาษี
...
- การอุดหนุนบางอย่าง จะมาในรูปแบบเครดิตภาษี ซึ่งสามารถแจ้งรับสิทธิได้ที่
...
- นักศึกษาต่างชาติ (Non-EU) ที่พำนักหรือมีแผนจะพำนักในไอร์แลนด์อย่างน้อย 1 ปี
  [อาจมีสิทธิออกคะแนนเสียง](https://www.citizensinformation.ie/en/government-in-ireland/elections-and-referenda/voting/right-to-vote/#2f693d)ในการเลือกตั้งท้องถิ่นได้
  โดยจะต้องลงทะเบียนผู้ออกคะแนนเสียงก่อน หลักฐานสำหรับการลงทะเบียนคือเอกสารที่แสดงชื่อตัวและที่อยู่บ้าน
  ดูรายละเอียดเพิ่มเติมในเว็บไซต์คณะกรรมการการเลือกตั้ง
